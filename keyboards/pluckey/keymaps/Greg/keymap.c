...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LCBR, KC_HOME,      KC_END,  KC_RCBR, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          KC_LGUI, KC_LALT, MO_LOW,      KC_SPC,    MO_LOW,            MO_RAIS,    KC_ENT,      KC_RALT, KC_RALT, KC_MEH
    ),
    [_LOWER] = LAYOUT_all(
    ...
    [_RAISE] = LAYOUT_all(
        ...
        _______, _______, _______, KC_VOLU, _______, _______, KC_LPRN,                        KC_RPRN, KC_HOME, KC_BTN4, KC_UP,   KC_BTN5, _______, _______,
        _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, KC_LPRN,                        KC_RPRN, KC_END, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  _______,
